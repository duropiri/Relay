  ...
  return (
    <section class="py-12" id="how-it-works">
      <div class="mx-auto max-w-7xl px-5">
        ...
        <h2 class="mt-2 text-3xl font-medium tracking-tight text-white sm:text-6xl text-center">
          <span class="bg-gradient-to-b from-neutral-50 from-60% to-neutral-400 bg-clip-text text-transparent lg:to-neutral-600">
            Why Are Our Landing Pages So <span class="bg-gradient-to-b from-blue-500 from-60% to-blue-400 bg-clip-text text-transparent lg:to-blue-600 underline">Effective?</span>
          </span>
        </h2>
        <img
          src="/svg/svgexport-1.svg"
          alt="Journey Desktop"
          class="mt-16 w-full hidden sm:block"
          width="1031"
          height="323"
          loading="lazy"
          decoding="async"
        ...
        <div class="grid md:grid-cols-3 gap-6 mt-12">
          ...
          <div class="flex flex-col bg-neutral-950 rounded-xl p-4 border-neutral-700 border">
            <div class="flex flex-row gap-x-8 items-center justify-start">
              <div class="mt-2 font-melodrama text-3xl font-medium tracking-tight text-white sm:text-6xl">
              ...
              <h4 class="mt-2 text-xl md:text-3xl font-medium tracking-tight text-white ">

...
const Why = () => {
  ...
  useEffect(() => {
    const loadGSAP = async () => {
      ...
      const section = document.querySelector("#moveImages");
  ...
  return (
    <section className="relative py-12 overflow-x-hidden" id="why">
      <div className="mx-auto max-w-7xl px-5">
        ...
        <div className="relative" id="moveImages">
              ...
              <div className="lg:pr-8 lg:pt-4">
                <div className="lg:max-w-lg">
                  ...
                  <p className="text-md mt-6 font-light text-neutral-300 md:text-lg">
                    {/* {WhyDescription1} */}
                    Our team expertly crafts, builds, and manages custom
                    marketing funnels tailored to boost your sales from paid
                    traffic. With our complete management, you can focus solely
                    on your business without worrying about the technical
                    details.
                  </p>
                  <a href="/contact">
              ...
              <div className="lg:ml-auto lg:pl-4 lg:pt-4">
                <div className="lg:max-w-lg">
                  ...
                  <p className="text-md mt-6 font-light text-neutral-300 md:text-lg">
                    ...
                    ensure our funnels perform up to 10 times faster than
                    standard websites and achieve conversion rates 1.5 times
                    higher than conventional websites. This approach enhances
                    user experiences and significantly boosts your conversion
                    rates.
                  </p>
                  <a href="/contact">

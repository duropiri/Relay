...
const HorizontalScroll: React.FC<AnimationProps> = ({ children, className }) => {
  ...
  const x = useTransform(
    scrollYProgress,
    [0, 1],
    ["0px", `-${totalWidth - viewportWidth}px`]
  );
  ...
  const dynamicHeight = (totalWidth / viewportWidth) * 100; // Example conversion factor, adjust as needed

  ...
  return (
    ...
    >
      ...
      <div className="sticky bg-neutral-950/75 backdrop-blur-md p-6 border-neutral-700 border-b-[1px] flex flex-row justify-between z-10">
        ...
        <button
          type="button"
          className="transition-opacity text-neutral-300 focus:outline-none  disabled:pointer-events-none data-[state=open]:bg-neutral-950"
        ...
        >
          <svg
            ...
            className="lucide lucide-x h-7 w-7"
          >
          ...
          {/* <div className="text-sm grid grid-cols-1 gap-4 items-center">
            ...
            >
              ...
              <p className="mt-1 md:mt-4 hidden text-sm md:block font-light text-neutral-400 group-hover:text-neutral-300">
                We design, develop and deploy custom marketing funnels designed
                to convert more paid traffic into sales.
              </p>
            </a>
            <a

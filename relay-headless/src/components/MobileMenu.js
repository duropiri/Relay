...
const MobileMenu = () => {
  ...
  return (
    <div
      ...
      data-state="open"
      class="fixed z-50 gap-4 border-neutral-700 p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 inset-y-0 right-0 h-full border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm w-screen bg-neutral-950"
      tabindex="-1"
    >
      <div>
        <a
      ...
      <div class="flex flex-col justify-start w-full h-full py-12 gap-y-6">
        <a
          href="/#why"
        ...
        <div class="  text-sm grid grid-cols-1 gap-4 items-center">
          ...
          >
            <svg
              ...
              class="absolute h-6 w-6 -top-3 -left-3 text-neutral-50"
            >
              <path
            ...
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              class="absolute h-6 w-6 -bottom-3 -left-3 text-neutral-50"
            >
              <path
                d="M8 2.75C8 2.47386 7.77614 2.25 7.5 2.25C7.22386 2.25 7 2.47386 7 2.75V7H2.75C2.47386 7 2.25 7.22386 2.25 7.5C2.25 7.77614 2.47386 8 2.75 8H7V12.25C7 12.5261 7.22386 12.75 7.5 12.75C7.77614 12.75 8 12.5261 8 12.25V8H12.25C12.5261 8 12.75 7.77614 12.75 7.5C12.75 7.22386 12.5261 7 12.25 7H8V2.75Z"
                fill="currentColor"
            ...
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              class="absolute h-6 w-6 -top-3 -right-3 text-neutral-50"
            >
              <path
                d="M8 2.75C8 2.47386 7.77614 2.25 7.5 2.25C7.22386 2.25 7 2.47386 7 2.75V7H2.75C2.47386 7 2.25 7.22386 2.25 7.5C2.25 7.77614 2.47386 8 2.75 8H7V12.25C7 12.5261 7.22386 12.75 7.5 12.75C7.77614 12.75 8 12.5261 8 12.25V8H12.25C12.5261 8 12.75 7.77614 12.75 7.5C12.75 7.22386 12.5261 7 12.25 7H8V2.75Z"
                fill="currentColor"
            ...
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              class="absolute h-6 w-6 -bottom-3 -right-3 text-neutral-50"
            >
              <path
                d="M8 2.75C8 2.47386 7.77614 2.25 7.5 2.25C7.22386 2.25 7 2.47386 7 2.75V7H2.75C2.47386 7 2.25 7.22386 2.25 7.5C2.25 7.77614 2.47386 8 2.75 8H7V12.25C7 12.5261 7.22386 12.75 7.5 12.75C7.77614 12.75 8 12.5261 8 12.25V8H12.25C12.5261 8 12.75 7.77614 12.75 7.5C12.75 7.22386 12.5261 7 12.25 7H8V2.75Z"
                fill="currentColor"
            ...
            <div class="flex h-12 md:h-9 lg:h-12 w-8 lg:w-12 items-center justify-center rounded-lg  text-neutral-100 md:text-neutral-200 group-hover:text-neutral-50 group-hover:translate-x-2 duration-300 ">
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 15"
            ...
            <a
              href="/services/marketing-funnels"
              class="md:mt-6 block text-center font-melodrama font-semibold text-2xl tracking-tight text-neutral-100 md:text-neutral-200 group-hover:text-neutral-50 leading-tight"
            >
              Marketing Funnels
            </a>
            <p class="mt-1 md:mt-4 hidden text-sm md:block font-light text-neutral-400 group-hover:text-neutral-300">
              We design, develop and deploy custom marketing funnels designed to
              convert more paid traffic into sales.
            </p>
          </a>
          <a
          ...
          >
            ...
            <p class="mt-1 md:mt-4 hidden text-sm md:block font-light text-neutral-400 group-hover:text-neutral-300">
              We will help you create, manage and optimize your digital ad
              campaigns to get more out of your ad spend.
            </p>
          </a>
          <a
          ...
          >
            ...
            <p class="mt-1 md:mt-4 hidden text-sm md:block font-light text-neutral-400 group-hover:text-neutral-300">
              Bring your email marketing to the next level with our custom email
              marketing services with no monthly fees.
            </p>
          </a>
          <a
          ...
          >
            ...
            <p class="mt-1 md:mt-4 hidden text-sm md:block font-light text-neutral-400 group-hover:text-neutral-300">
              Have a custom website built for your business that is designed to
      ...
      <button
        type="button"
        class="absolute right-6 top-4 transition-opacity text-neutral-300 focus:outline-none  disabled:pointer-events-none data-[state=open]:bg-neutral-950"
      ...
      >
        <svg
          ...
          class="lucide lucide-x h-10 w-10"
        >
